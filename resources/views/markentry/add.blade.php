  ...
  <div class="container">
    <div class="row mt-5">
      <div class="col-sm-8 offset-sm-2">
        <form action="{{ url('markentry') }}" method="post">
          @csrf
          @if( session('message'))
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              @php
              echo $controller->getStudentcombo('');
              @endphp
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            <div class="col-sm-2">
              <label for="firstname">Maths:</label>
            </div>
            <div class="col-sm-4">
              <input type="text" name="maths" id="maths" class="form-control" required>
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input type="text" name="science" id="science" class="form-control" required>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-sm-2">
              <label for="firstname">History:</label>
            </div>
            <div class="col-sm-4">
              <input type="text" name="history" id="history" class="form-control" required>
            </div>
          </div>
