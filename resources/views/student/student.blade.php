            ...
            <div class="card">
                <div class="row m-4">
                    ...
                    <div class="col-sm-12 float-right">
                        <button type="button" class="btn btn-sm  btn-primary" data-toggle="modal" data-target="#modal-add" onclick="return loadAddForm('student');" style="margin-bottom: 10px; float:right">Add New</button>
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 80px;">Reporting Teacher</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $value->gender == 'male' ? 'M' : 'F'}}</td>
                                <td class="text-center">{{$value->reporting_teacher}}</td>
                                <td class="text-center">
                                    <a class="btn btn-small btn-info" href="{{ url('student/edit',[$value->id]) }}">Edit</a>
                                    <a class="btn btn-small btn-danger" href="{{ url('student/delete',[$value->id]) }}">Delete</a>
